...
function applyTerminalTheme(theme) {
  ...
  const themes = {
    light: { background: "#ffffff", foreground: "#111827", cursor: "#111827" },
    dark: { background: "#020617", foreground: "#e5e7eb", cursor: "#e5e7eb" },
    dracula: {
  background: "#0d1117",
  foreground: "#c9d1d9",
  cursor: "#58a6ff",
  ...
  brightWhite: "#f0f6fc"
    ...
    system: prefersDark
      ? { background: "#020617", foreground: "#e5e7eb", cursor: "#e5e7eb" }
